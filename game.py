...
def create_questions():
    while True:
        ...
        temp_question = Question(question, answer, fake_answer1, fake_answer2, fake_answer3)
        set_of_questions.append(temp_question)
        user_choice2 = input(
            "Would you like to view the current questions, make another, or go play? Input View, Make, or Play.\n")
        if user_choice2 == "View":
            for question in set_of_questions:
                print("Q: " + question.question + " A: " + question.answer)
        elif user_choice2 == "Make":
            continue
        elif user_choice2 == "Play":
            pass
